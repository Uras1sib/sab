        ...
        task.spawn(function()
            while tpwalking and char.Parent and hum.Health > 0 do
                ...
                if moveDir.Magnitude > 0 then
                    -- MOBİL VE PC İÇİN ORTAK HAREKET MANTIGI:
                    -- Karakterin joystick/tuş yönünü kameranın baktığı açıya çeviriyoruz.
                    -- Bu sayede mobilde havaya bakıp joystick ileri itilince yukarı çıkar.
                    local cameraCFrame = cam.CFrame
                    local direction = cameraCFrame:VectorToWorldSpace(cameraCFrame:VectorToObjectSpace(moveDir))
